...
#ifndef FACEREC_NCNN_TYPES_H
#define FACEREC_NCNN_TYPES_H
...
namespace types {
    ...
    struct BoundingBoxType {
        ...
        BoundingBoxType() :
                ...
                flag(false) { types::__assert_type<value_type, score_type>(); }
    }; // End BoundingBox.
...
inline types::BoundingBoxType<O1, O2>
types::BoundingBoxType<T1, T2>::convert_type() const {
...
types::BoundingBoxType<T1, T2>::iou_of(const BoundingBoxType<O1, O2> &other) const {
